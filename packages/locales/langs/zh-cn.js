const local = {
  ...
  page: {
    ...
    about: {
      title: '关于',
      introduction: `XmAdmin 是一个优雅且功能强大的后台管理模板，基于最新的前端技术栈，包括 Vue3, Vite7, TypeScript, Pinia 和 UnoCSS。它内置了丰富的主题配置和组件，代码规范严谨，实现了自动化的文件路由系统。此外，它还采用了基于 ApiFox 的在线Mock数据方案。XmAdmin 为您提供了一站式的后台管理解决方案，无需额外配置，开箱即用。同样是一个快速学习前沿技术的最佳实践。`,
      projectInfo: {
        title: '项目信息',
        version: '版本',
    ...
    home: {
      ...
      projectNews: {
        title: '项目动态',
        moreNews: '更多动态',
        desc1: 'Xm 在2025年5月28日创建了开源项目 Xm-admin!',
        desc2: 'Yanbowe 向 Xm-admin 提交了一个bug，多标签栏不会自适应。',
        desc3: 'Xm 准备为 Xm-admin 的发布做充分的准备工作!',
        desc4: 'Xm 正在忙于为Xm-admin写项目说明文档！',
        desc5: 'Xm 刚才把工作台页面随便写了一些，凑合能看了！'
      },
      creativity: '创意'
    },
    function: {
