const local = {
  ...
  page: {
    ...
    about: {
      title: 'About',
      introduction: `XmAdmin is an elegant and powerful admin template, based on the latest front-end technology stack, including Vue3, Vite7, TypeScript, Pinia and UnoCSS. It has built-in rich theme configuration and components, strict code specifications, and an automated file routing system. In addition, it also uses the online mock data solution based on ApiFox. XmAdmin provides you with a one-stop admin solution, no additional configuration, and out of the box. It is also a best practice for learning cutting-edge technologies quickly.`,
      projectInfo: {
        title: 'Project Info',
        version: 'Version',
    ...
    home: {
      ...
      projectNews: {
        title: 'Project News',
        moreNews: 'More News',
        desc1: 'Xm created the open source project Xm-admin on May 28, 2021!',
        desc2: 'Yanbowe submitted a bug to Xm-admin, the multi-tab bar will not adapt.',
        desc3: 'Xm is ready to do sufficient preparation for the release of Xm-admin!',
        desc4: 'Xm is busy writing project documentation for Xm-admin!',
        desc5: 'Xm just wrote some of the workbench pages casually, and it was enough to see!'
      },
