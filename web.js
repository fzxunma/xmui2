...
await myWindow.show(`<iframe src="https://weread.qq.com/" style="border:none;width:100%;height:100%"></iframe>`);
// Show the window
//await myWindow.showBrowser('https://weread.qq.com/', WebUI.Browser.AnyBrowser); // Or await myWindow.show('./myFile.html');
